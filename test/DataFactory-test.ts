  ...
  describe('literal', () => {
    ...
    it('should handle equals', () => {
      ...
      expect(factory.literal('a', { language: 'en-us', direction: '' })
        .equals(literalNullDirection)).toBe(true);

      expect(factory.literal('a')
        .equals(factory.literal('a', 'en-us'))).toBe(false);
      expect(factory.literal('a')
        .equals(factory.literal('a', factory.namedNode('ex:dt')))).toBe(false);
      expect(factory.literal('a')
        .equals(factory.literal('a', factory.namedNode('http://www.w3.org/2001/XMLSchema#string')))).toBe(true);

      expect(factory.literal('a', { language: 'en-us', direction: 'ltr' })
        .equals(factory.literal('a', { language: 'en-us', direction: 'rtl' }))).toBe(false);
      expect(factory.literal('a', { language: 'en-us' })
        .equals(factory.literal('a', { language: 'en-us', direction: 'rtl' }))).toBe(false);
      expect(factory.literal('a', 'en-us')
        .equals(factory.literal('a', { language: 'en-us', direction: 'rtl' }))).toBe(false);
      ...
      expect(factory.literal('a', 'en-us')
        .equals(factory.literal('a'))).toBe(false);
      expect(factory.literal('a', 'en-us')
        .equals(factory.literal('a', factory.namedNode('ex:dt')))).toBe(false);
      expect(factory.literal('a', 'en-us')
        .equals(factory.literal('a', factory.namedNode('http://www.w3.org/1999/02/22-rdf_syntax-ns#langString')))).toBe(false);

      expect(factory.literal('a', factory.namedNode('ex:dt'))
        .equals(factory.literal('a'))).toBe(false);
      expect(factory.literal('a', factory.namedNode('ex:dt1'))
        .equals(factory.literal('a', factory.namedNode('ex:dt2')))).toBe(false);
      expect(factory.literal('a', factory.namedNode('ex:dt'))
        .equals(factory.literal('a', factory.namedNode('http://www.w3.org/2001/XMLSchema#string')))).toBe(false);
    });
  });
